...
FullColorPicker.SlidersList = [];

FullColorPicker.DefaultSliderSettings = {
	xMinValue: 0,
	xMaxValue: 100,
	yMinValue: 0,
	yMaxValue: 100,
...
FullColorPicker.Slider = Class.create({
	_bar: null,
	_arrow: null,
	...
	initialize: function(id, settings) {
		...
		this.id = id;
		this.settings = Object.extend(Object.extend({},FullColorPicker.DefaultSliderSettings), settings || {});
		...
		this._bar.observe('mousedown', this._bar_mouseDown.bindAsEventListener(this));
		this._arrow.observe('mousedown', this._arrow_mouseDown.bindAsEventListener(this));
		...
		// final setup
		FullColorPicker.SlidersList.push(this);
	},
	...
	_mouseDown: function(e) {
		FullColorPicker.ActiveSlider = this;
		
		this.setValuesFromMousePosition(e);
		
		document.observe('mousemove', this._event_docMouseMove);
		document.observe('mouseup', this._event_docMouseUp);		
	...
	_docMouseUp: function(e) {
		document.stopObserving('mouseup', this._event_docMouseUp);
		document.stopObserving('mousemove', this._event_docMouseMove);
		e.stop();
	},	
