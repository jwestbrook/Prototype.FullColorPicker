...
FullColorPicker.Color = function(init) {	
	var color = {
		r: 0,
		g: 0,
		b: 0,
		...
		setRgb: function(r, g, b) {
			...
			var newHsv = FullColorPicker.ColorMethods.rgbToHsv(this);
			this.h = newHsv.h;
			this.s = newHsv.s;
			this.v = newHsv.v;
			
			this.hex = FullColorPicker.ColorMethods.rgbToHex(this);					
		},
		...
		setHsv: function(h, s, v) {
			...
			var newRgb = FullColorPicker.ColorMethods.hsvToRgb(this);
			this.r = newRgb.r;
			this.g = newRgb.g;
			this.b = newRgb.b;	
			
			this.hex = FullColorPicker.ColorMethods.rgbToHex(newRgb);	
		},
		
		setHex: function(hex) {
			this.hex = hex;
			
			var newRgb = FullColorPicker.ColorMethods.hexToRgb(this.hex);
			this.r = newRgb.r;
			this.g = newRgb.g;
			this.b = newRgb.b;
			
			var newHsv = FullColorPicker.ColorMethods.rgbToHsv(newRgb);
			this.h = newHsv.h;
			this.s = newHsv.s;
			this.v = newHsv.v;			
		}
