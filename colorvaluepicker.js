...
FullColorPicker.ColorValuePicker = Class.create({
	initialize: function(id) {
		...
		// HSB
		this._hueInput.observe('keyup', this._event_onHsvKeyUp);

		this._valueInput.observe('keyup',this._event_onHsvKeyUp);
		this._saturationInput.observe('keyup',this._event_onHsvKeyUp);
		this._hueInput.observe('blur', this._event_onHsvBlur);
		this._valueInput.observe('blur',this._event_onHsvBlur);
		this._saturationInput.observe('blur',this._event_onHsvBlur);

		// RGB
		this._redInput.observe('keyup', this._event_onRgbKeyUp);
		this._greenInput.observe('keyup', this._event_onRgbKeyUp);
		this._blueInput.observe('keyup', this._event_onRgbKeyUp);
		this._redInput.observe('blur', this._event_onRgbBlur);
		this._greenInput.observe('blur', this._event_onRgbBlur);
		this._blueInput.observe('blur', this._event_onRgbBlur);

		// HEX
		this._hexInput.observe('keyup', this._event_onHexKeyUp);
		
		this.color = new FullColorPicker.Color();
